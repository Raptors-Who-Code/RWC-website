...
exports.verifiedMiddleware = void 0;
const exceptions_1 = require("../exceptions/exceptions");
const root_1 = require("../exceptions/root");
const __1 = require("..");
const verifiedMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user.verified) {
        ...
        next(new exceptions_1.UnauthorizedException("User is not verified", root_1.ErrorCode.UNAUTHORIZED));
    }
});
