...
exports.getEmailResetTemplate = exports.getVerifyEmailTemplate = exports.getPasswordResetTemplate = void 0;
...
const getEmailResetTemplate = (url, oldUserEmail, newEmail) => ({
    subject: "Email Reset Request",
    text: `You requested an email change from ${oldUserEmail} to ${newEmail}. Click on the link to confirm the change: ${url}`,
    html: `<!doctype html>
<html lang="en-US">
<head>
  <meta content="text/html; charset=utf-8" http-equiv="Content-Type"/>
  <title>Email Change Verification</title>
  <meta name="description" content="Email Change Verification Email Template">
              ...
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px;background:#fff; border-radius:3px; text-align:center;-webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);-moz-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);box-shadow:0 6px 18px 0 rgba(0,0,0,.06);">
                ...
                <tr>
                  <td style="padding:0 35px;">
                    <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Please verify your email change</h1>
                    <span style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                    <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                      We received a request to change your email address. If you didn't initiate this request, please ignore this email. Otherwise, confirm the change below:
                    </p>
                    <p style="color:#455056; font-size:15px;line-height:24px; margin:20px 0;">
                      <strong>Old Email:</strong> ${oldUserEmail} <br/>
                      <strong>New Email:</strong> ${newEmail}
                    </p>
                    <a target="_blank" href="${url}" style="background:#2f89ff;text-decoration:none !important; font-weight:500; margin-top:24px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">
          ...
          <tr>
            <td style="text-align:center;">
              <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">
                &copy; ${new Date().getFullYear()} Raptors Who Code. All Rights Reserved.
              </p>
            </td>
          </tr>
          <tr>
...
exports.getEmailResetTemplate = getEmailResetTemplate;
